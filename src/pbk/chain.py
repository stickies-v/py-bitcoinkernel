...
from pbk import Block, BlockIndex
...
class ChainstateManager(KernelOpaquePtr):
    ...
    def read_block_from_disk(self, block_index: "BlockIndex") -> Block:
        ...
        if not block:
            raise RuntimeError("Error reading block from disk")
...
def block_index_generator(
    ...
    start: "BlockIndex | None" = None,  # default to genesis
    end: "BlockIndex | None" = None     # default to chaintip
